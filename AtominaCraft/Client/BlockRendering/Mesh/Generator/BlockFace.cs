...
namespace AtominaCraft.Client.BlockRendering.Mesh.Generator
{
    public struct BlockFace
    {
        ...
        public static Vertex2 VT1 = new Vertex2(2.0f, 0.0f);
        public static Vertex2 VT2 = new Vertex2(1.0f, 1.0f);
        public static Vertex2 VT3 = new Vertex2(1.0f, 0.0f);
        public static Vertex2 VT4 = new Vertex2(0.0f, 2.0f);
        public static Vertex2 VT5 = new Vertex2(0.0f, 1.0f);
        public static Vertex2 VT6 = new Vertex2(1.0f, -2.0f);
        public static Vertex2 VT7 = new Vertex2(0.0f, -1.0f);
        public static Vertex2 VT8 = new Vertex2(0.0f, -2.0f);
        public static Vertex2 VT9 = new Vertex2(0.0f, 0.0f);
        public static Vertex2 VT10 = new Vertex2(-1.0f, 1.0f);
        public static Vertex2 VT11 = new Vertex2(-1.0f, 0.0f);
        public static Vertex2 VT12 = new Vertex2(1.0f, -1.0f);
        public static Vertex2 VT13 = new Vertex2(2.0f, 1.0f);
        public static Vertex2 VT14 = new Vertex2(1.0f, 2.0f);
