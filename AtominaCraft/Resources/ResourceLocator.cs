...
namespace AtominaCraft.Resources
{
    public static class ResourceLocator
    {
        ...
        {
            string texturePath = GetTexturesDirectory();
            string textureFilePath = Path.Combine(texturePath, fileName);
            return textureFilePath ?? (File.Exists(textureFilePath) ? textureFilePath : string.Empty);
        }
    }
}
